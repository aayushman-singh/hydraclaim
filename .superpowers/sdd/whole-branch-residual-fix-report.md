...
2. Chain reads track the current traversal path. They reject a true directed
   cycle and accept one shared ancestor reached from two valid branches.
...
| `python -m pytest -q -m "not artifact"` | 363 passed, 1 deselected |
...
| `python -m pytest -q -m artifact` | 1 passed, 363 deselected |
